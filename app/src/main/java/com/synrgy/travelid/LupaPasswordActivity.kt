...
import com.febi.projek.databinding.ActivityLupaPasswordBinding
...
class LupaPasswordActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?){
        ...
        binding?.buttonKirimLupaPw?.setOnClickListener{
...
//            if(emailvaliddd)
    ...
    private fun observeViewModel(){
        viewModel.openBottomSheet.observe(this) { handleOpenBottomSheet()}
        viewModel.error.observe(this, ::handleError)
    }

    private fun handleOpenBottomSheet() {
        binding?.buttonKirimLupaPw?.setOnClickListener{
