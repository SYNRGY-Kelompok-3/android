...
import com.synrgy.travelid.databinding.FragmentPilihKotaTujuanBinding
import dagger.hilt.android.AndroidEntryPoint

@AndroidEntryPoint
class PilihKotaTujuanFragment : BottomSheetDialogFragment() {
    private lateinit var binding: FragmentPilihKotaTujuanBinding
    interface DestinationCitySelectionListener {
        fun onDestinationCitySelected(city: String)
    }
    private var destinationCitySelectionListener: DestinationCitySelectionListener? = null
    ...
    override fun onCreateView(
        ...
        binding = FragmentPilihKotaTujuanBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    private fun bindView() {
        binding.btnSimpan.setOnClickListener {
            selectedCity?.let { city ->
                destinationCitySelectionListener?.onDestinationCitySelected(city)
                dismiss()
            }
        }
    ...
    fun setDestinationCitySelectionListener(listener: DestinationCitySelectionListener) {
        destinationCitySelectionListener = listener
    }
}